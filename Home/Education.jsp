...
<html class="no-js">
    ...
    <head>
        ...
        <link href="css/jplayer-black-and-yellow.css" rel="stylesheet" type="text/css" />
        ...
        <header>
            <div class="wrapper cf">
                ...
                <ul id="nav" class="sf-menu">
                    ...
                    <li><a href="blog.html">PRODUCT & SOLUTION</a>
                        <ul>
                            <ul>
                            <li><a href="Education.jsp">Education </a></li>
                            <li><a href="Software.jsp">Software</a></li>
                            <li><a href="Web_application.jsp">Web Aplication</a></li>
                            <li><a href="IoT.jsp">IoT</a></li>
                            <li><a href="Robotic.jsp">Robotic</a></li>
                            </ul>
                        </ul>
