...
<html class="no-js">
    ...
    <head>
        ...
        <script  src="../js/uperfish.js"></script>
        <script  src="../js/supersubs.js"></script>
        <!-- ENDS superfish -->

        <!-- prettyPhoto -->
        <script  src="../js/jquery.prettyPhoto.js"></script>
        <link rel="stylesheet" href="../js/jquery.prettyPhoto.css"  media="screen" />
        <!-- ENDS prettyPhoto -->

        <!-- poshytip -->
        <link rel="stylesheet" href="../js/tip-twitter.css"  />
        <link rel="stylesheet" href="../js/tip-yellowsimple.css"  />
        ...
        <header>
            <div class="wrapper cf">
                ...
                <ul id="nav" class="sf-menu">
                    ...
                    <li><a href="blog.html">PRODUCTION & SOLUTION</a></li> 
                            <ul>
                                <ul>
                                    <li><a href="../Home/Education.jsp">EDUCATION </a></li>
                                    <li><a href="../Home/Software.jsp">SOFTWARE</a></li>
                                    <li><a href="../Home/Web_application.jsp">WEB APLICATION</a></li>
                                    <li><a href="../Home/Robotic.jsp">ROBOTIC</a></li>
                                </ul>         

                            </ul>
                    <li><a href="page.html">TECHNOLOGY</a>
                        <ul>
                            <ul>
                                <li><a href="../Aplication_Development.jsp">APLICATION DEVELOPMENT</a></li>
                                <li><a href="../Robotic_Automation.jsp">ROBOTIC & AUTOMATION</a></li>
                                <li><a href="../WebDeveloper.jsp">WEB DEVELOPER</a></li>
                                <li><a href="../Home/IoT.jsp">IoT</a></li>
                            </ul>
                        </ul>
                    </li>
                ...
                <div id="portfolio-content" class="cf">        	
                    ...
                    <div id="project-box" class="cf">
                        ...
                        <div class="project-slider">
                            <div class="flexslider">
                                <ul class="slides">
                                    <li>
                                        <img src="../image/mblr.jpg" alt="alt text" />
                                    </li>
                                    <li>
                                        <img src="../image/rr.jpg" alt="alt text" />
                                    </li>
                                    <li>
                                        <img src="../image/uav.jpg" alt="alt text" />
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div class="related-projects">
                        ...
                        <div class="related-list cf">
                            <figure>
                                <a href="#" class="thumb"><img src="=../image/uav.jpg" alt= "Alt text" /></a>
